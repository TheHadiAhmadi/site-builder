        ...
        <div data-name="iframe">
            <div data-content-header>
                ...
                <div data-header-actions>
                    ...
                    ${permissions.page_update || permissions.page_seo ? `<a data-enhance data-button ${page?.dynamic ? 'data-button-icon' : ''} data-button-color="default" href="${getUrl({ view: 'pages.update', id: page?.id, back: encodeURIComponent('?mode=edit&view=iframe') })}">
