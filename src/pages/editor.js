        ...
        <div data-name="iframe">
            <div data-content-header>
                ...
                <div data-header-actions>
                    ...
                    ${permissions.page_update || permissions.page_seo ? `<a data-enhance data-button data-button-color="default" href="${getUrl({ view: 'pages.update', id: page?.id, back: encodeURIComponent('?mode=edit&view=iframe') })}">
                            ...
                            ${permissions.page_update ? '' : `<span data-page-settings-text>Page Settings</span>`}
                        </a>`: ''}
                    ${view === 'iframe' ? `
                        <a data-enhance href="?mode=edit&view=pages.edit" data-button data-button-color="primary">Done</a>
                    ` : `
                        <a target="_blank" href="${url.split('?')[0]}" data-button>Preview</a>
                        ${permissions.page_content || permissions.page_update ? `<a data-enhance href="?mode=edit&view=iframe" data-button data-button-color="primary">Edit</a>` : ''}
                    `}
                </div>
            </div>
